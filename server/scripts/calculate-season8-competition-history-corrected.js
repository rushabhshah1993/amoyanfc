...
function loadSeason8Data() {
  ...
  console.log(`📂 Loading Season 8 migrated data from: ${migratedPath}`);
...
function loadStandingsData() {
  ...
  console.log(`📂 Loading Season 8 standings from: ${standingsPath}`);
...
function calculateSeason8Statistics(seasonData, standingsData, fightersData) {
  console.log('\n📊 Calculating Season 8 competition history...');
...
function calculateCompetitionHistory() {
  ...
  try {
    ...
    console.log(`\n✅ Calculated competition history for ${season8Stats.length} fighters`);
